...
export default function AdminLayout({ children }) {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#f1f5f9' }}>
      {/* Sidebar */}
      <aside style={{ width: '240px', minWidth: '240px', backgroundColor: '#005BBE', color: 'white', display: 'flex', flexDirection: 'column', position: 'sticky', top: 0, height: '100vh', boxShadow: '2px 0 8px rgba(0,0,0,0.1)' }}>
        {/* Logo + usuario */}
